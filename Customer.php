...
<body>
    ...
    <div class="order-history-section md:w-6/12 m-auto">
        ...
        <table class="table-auto w-full border-collapse border border-gray-300">
            ...
            ?>
                <tr>
                    <td class="border border-gray-300 px-4 py-2"><?php echo htmlspecialchars($row['book_name']); ?></td>
                    <td class="border border-gray-300 px-4 py-2"><?php echo htmlspecialchars($row['book_category']); ?></td>
                    <td class="border border-gray-300 px-4 py-2"><?php echo htmlspecialchars($row['book_price']); ?></td>
                </tr>
            <?php
            }
            ?>
