...
<body>
    ...
    <div class="order-history-section md:w-8/12 m-auto">
        <div class="flex w-full pb-5 md:w-6/12 m-auto">
            ...
            <a href="car.php" class="text-center w-[50%] border-b-2 border-red-500 py-3 m-auto">Book List</a>
            <a href="sell.php" class="text-center w-[50%] border-b-2 border-gray-100 py-3 m-auto">Sell History</a>
        </div>
        <a class="bg-blue-500 text-white px-5  py-2 rounded-xl mb-5" href="addcar.php">ADD BOOK</a>
            ...
            <tbody>
                <?php 
                    ...
                    <tr">
                        ...
                        <td class="border border-gray-300 px-4 py-2"><?php echo $row['category']?></td>
                        ...
                        <td class="border border-gray-300 px-4 py-2">
                            <a class="bg-blue-500 text-white px-5  py-1 rounded-xl" href="editCarInfo.php?name=<?php echo urlencode($row['name']); ?>" class="btn btn-primary">Edit</a>
                            <a class="bg-red-500 text-white px-5  py-1 rounded-xl" href="confiq/deleteCar.php?name=<?php echo urlencode($row['name']); ?>" class="btn btn-primary">Delete</a>
                        </td>
                    </tr>
                    <?php
                    }
