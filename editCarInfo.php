...
if(isset($_GET['name'])) {
    ...
    $u_sql = "SELECT * FROM book WHERE name=?";
    ...
    <!-- main -->
     <div class="flex flex-col relative">
        ...
        <form action="confiq/editCarconfiq.php" method="POST" enctype="multipart/form-data" class="sign-in-form flex flex-col items-center justify-center gap-4">
            ...
            <input class="scale-110 shadow-sm px-10 py-2 rounded-full shadow-gray-500" type="text" value="<?php echo $u_row['name']; ?>"  name="name" required placeholder="Enter Edited Book Name">
            <input class="scale-110 shadow-sm px-10 py-2 rounded-full shadow-gray-500" type="text" value="<?php echo $u_row['category']; ?>"  name="type" required placeholder="Enter Edited Book category">
            <input class="scale-110 shadow-sm px-10 py-2 rounded-full shadow-gray-500" type="text" value="<?php echo $u_row['price']; ?>"  name="model" required placeholder="Enter Edited Book Price">
